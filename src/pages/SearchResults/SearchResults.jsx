...
export default function SearchResults({user, curSearch, curData, setCurData, pagination, setPagination, handleSearch, setPlant, getUserPlants}) {
        ...
        <div className='results-container'>
            ...
            <div className='results-masonry'>
                {curData.map((item, idx) => 
                    <SearchResultCard key={idx} user={user} item={item} setPlant={setPlant} getUserPlants={getUserPlants}/>
                )}
            </div>
